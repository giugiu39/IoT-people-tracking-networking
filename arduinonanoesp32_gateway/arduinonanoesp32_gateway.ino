#define MQTT_MAX_PACKET_SIZE 512 // Espande il buffer per i payload cifrati
...
void reconnect_mqtt() {
    while (!mqtt.connected()) {
        ...
        String clientId = "ESP32NanoGateway-" + String(random(0, 1000));
...
void setup() {
    ...
    Serial.println("BLE Gateway nativo (Nano ESP32) attivo. In attesa del Tracker...");
}
